...
router.get('/requests/:page?', adminArea(), adminController.requests);
...
router.put('/request/accept/:id', adminArea(), adminController.requestAccept);

// Solicitação POST que apaga filme
router.delete('/request/reject/:id', adminArea(), adminController.requestReject);
